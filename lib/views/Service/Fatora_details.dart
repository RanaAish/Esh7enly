    ...
    return Column(children: [
      ...
      Text(
        ...
        widget.paymentobject.type == "1"
            ? translator.translate("pending2")
            : widget.paymentobject.type == "2"
                ?  translator.translate("success2")
     ...
     Card(
      ...
      child: Column(children: [ 
        ...
        Padding(padding: EdgeInsets.only(top: 10,bottom: 5),child: Text(translator.translate("service"),style: TextStyle(color: CustomColors.MainColor,fontSize: 17),),)
        ,SizedBox(
          width: 410,
          height: 70,
          child: Padding(
          ...
          child: Padding(
              ...
              child: Card(
                  ...
                  child: Padding(
                      padding: EdgeInsets.only(left: 20, top: 8,right:13),
                      child: Text(
                        "${translator.translate( "transid")} ${widget.paymentobject.id.toString()}",
                        style: TextStyle(
                            fontSize: 16,
                            color: CustomColors.MainColor,
                            fontWeight: FontWeight.bold),
          ...
          child: Padding(
              ...
              child: Card(
                  ...
                  child: Padding(
                      padding: EdgeInsets.only(left: 20, top: 8,right:13),
                      child: Text(
                          "${translator.translate("time")} ${widget.paymentobject.createdAt.toString()}",
                          style: TextStyle(
                            fontSize: 16,
                            color: CustomColors.MainColor,
                            fontWeight: FontWeight.bold,
          ...
          child: Padding(
              ...
              child: Card(
                  ...
                  child: Padding(
                      padding: EdgeInsets.only(left: 20, top: 8,right:13),
                      child: Text(
                        "${translator.translate("amunt")} ${widget.paymentobject.amount.toString()} EGP",
                        style: TextStyle(
                            fontSize: 16,
                            color: CustomColors.MainColor,
                            fontWeight: FontWeight.bold),
          ...
          child: Padding(
              ...
              child: Card(
                  ...
                  child: Padding(
                      padding: EdgeInsets.only(left: 20, top: 8,right:13),
                      child: Text(
                        "${translator.translate("totalamount")}  ${widget.paymentobject.totalAmount.toString()} EGP",
                        style: TextStyle(
                            fontSize: 16,
                            color: CustomColors.MainColor,
                            fontWeight: FontWeight.bold),
              ...
              child: Padding(
                  ...
                  child: Card(
                      ...
                      child: Padding(
                          padding: EdgeInsets.only(left: 20, top: 8,right:13),
                          child: Text(
                            "${translator.translate("before")} ${widget.paymentobject.balanceBefore.toString()}",
                            style: TextStyle(
                                fontSize: 16,
                                color: CustomColors.MainColor,
                                fontWeight: FontWeight.bold),
              ...
              child: Padding(
                  ...
                  child: Card(
                      ...
                      child: Padding(
                          padding: EdgeInsets.only(left: 20, top: 8,right:13),
                          child: Text(
                            "${translator.translate("after")}  ${widget.paymentobject.balanceAfter.toString()}",
                            style: TextStyle(
                                fontSize: 16,
                                color: CustomColors.MainColor,
                                fontWeight: FontWeight.bold),
              ...
              child: Padding(
                  ...
                  child: Card(
                      ...
                      child: Padding(
                          padding: EdgeInsets.only(left: 20, top: 8,right:13),
                          child: Text(
                              "${translator.translate("clientnum")} : ${widget.paymentobject.clientNumber.toString()}",
                              style: TextStyle(
                                  fontSize: 16,
                                  color: CustomColors.MainColor,
                                  fontWeight: FontWeight.bold)))))),
                            ...
                            child: Padding(
                                ...
                                child: Card(
                                    ...
                                    child: Padding(
                                        ...
                                        child: Text(
                                          "${translator.translate("error")}  ${widget.paymentobject.message.toString()}",
                                          style: TextStyle(
                                              color: CustomColors.MainColor,
                                              fontWeight: FontWeight.bold,
                                              fontSize: 16),
 ...
 createpdf() async {
    ...
    doc.addPage(pw.Page(
     ...
     pw.SizedBox(height: 5),
        ...
        pw.Padding(padding: pw.EdgeInsets.only(top: 10,bottom: 5),child: pw.Text( translator.translate("service"),style: pw.TextStyle(fontSize: 17),),)
        ,pw.SizedBox(
          width: 410,
          height: 60,
          child: pw.Padding(
